...
@Controller
	public class MainController {
	    ...
	    public String createTable(){
	         ...
	         * .stream() - Создаем из List поток (stream), можно сказать конвейер
	         * .map(inStr -> inStr.split(" ") - перобразуем каждую входную строку в массив строк, разделитель пробел
	         * .collect(Collectors.toList() - снова собираем все оъекты с конвейера в List и присваиваем переменной List<Object[]> splitUpNames
	         */
